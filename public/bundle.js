...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ColorList = __webpack_require__(160);
	...
	var Main = function Main(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_ColorList2.default, null)
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Color = __webpack_require__(178);
	...
	var ColorList = function (_React$Component) {
	  ...
	  function ColorList(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ColorList).call(this, props));

	    var randomColor = void 0;
	    _axios2.default.get('https://colourlovers.com/api/colors/random', {
	      format: 'json'
	    }).then(function (data) {
	      console.log(data);
	  ...
	  _createClass(ColorList, [{
	    ...
	    value: function handleKeyPress(e) {
	      ...
	      // Dislike
	        ...
	        // Remove Color
	            ...
	            var newColors = colors.splice(0, colors.length - 1);
	    ...
	    value: function render() {
	      var colors = this.state.colors.map(function (color) {
	        return _react2.default.createElement(
	          'li',
	          { key: Date.now(), style: { backgroundColor: color }, className: 'color' },
	          _react2.default.createElement(_Color2.default, { colorCode: color })
	        );
	      });
	      return _react2.default.createElement(
	        'div',
