...
/***/ function(module, exports, __webpack_require__) {
	...
	function onboardingStep() {
	  ...
	  switch (action.type) {
	    case _actions.CONTINUE_ONBOARDING:
	      return state + 1;
	    default:
	      return state;
	  }
	...
	function fetchedPalette() {
	  ...
	  switch (action.type) {
	    case _actions.REQUEST_PALETTE:
	      return _extends({}, state, {
	        isFetching: true,
	        didInvalidate: false
	      });
	    case _actions.RECEIVE_PALETTE:
	      return _extends({}, state, {
	        isFetching: false,
	        didInvalidate: false,
	        fetchedPalette: action.colors.map(function (color) {
	          return '#' + color;
	        })
	      });
	    case _actions.INVALIDATE_PALETTE:
	      return _extends({}, state, {
	        didInvalidate: true
	      });
	    default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.INVALIDATE_PALETTE = exports.RECEIVE_PALETTE = exports.REQUEST_PALETTE = exports.COPY_COLOR = exports.REMOVE_COLOR = exports.CHANGE_COLOR = exports.ADD_COLOR = exports.CONTINUE_ONBOARDING = undefined;
	...
	var REQUEST_PALETTE = exports.REQUEST_PALETTE = 'REQUEST_PALETTE';
	var RECEIVE_PALETTE = exports.RECEIVE_PALETTE = 'RECEIVE_PALETTE';
	var INVALIDATE_PALETTE = exports.INVALIDATE_PALETTE = 'INVALIDATE_PALETTE';
	...
	function invalidatePalette(palette) {
	  return {
	...
	function fetchPalette(shownColors) {
	  return function (dispatch) {
	    ...
	    var apiURL = shownColors.length <= 1 ? '/api/random' : '/api/change';
	...
	function shouldFetchPalette(state) {
	  ...
	  var _state$fetchedPalette = state.fetchedPalette;
	  var fetchedPalette = _state$fetchedPalette.fetchedPalette;
	  var isFetching = _state$fetchedPalette.isFetching;
	  var didInvalidate = _state$fetchedPalette.didInvalidate;
	...
	function fetchColorFromPaletteIfNeeded(shownColors) {
	  return function (dispatch, getState) {
	    var state = getState();
	    // FIXME: State tree feels weird here with double fetchedPalette
	    var getFetchedPalette = function getFetchedPalette() {
	      return getState().fetchedPalette.fetchedPalette;
	    };

	    if (shouldFetchPalette(state)) {
	      return dispatch(fetchPalette(shownColors)).then(function () {
	        var color = (0, _helpers.removeDuplicatesFrom)(shownColors, getFetchedPalette());
...
/***/ function(module, exports) {
	...
	exports.removeDuplicatesFrom = removeDuplicatesFrom;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Title = __webpack_require__(220);
	...
	var _ColorList = __webpack_require__(228);

	var _ColorList2 = _interopRequireDefault(_ColorList);

	var _Onboarding = __webpack_require__(252);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Title2.default, { shownColors: shownColors }),
	        _react2.default.createElement(_Tweet2.default, { shownColors: shownColors }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InterfaceTheme = __webpack_require__(221);
	...
	var Title = function Title(_ref) {
	  var shownColors = _ref.shownColors;

	  return _react2.default.createElement(
	    _InterfaceTheme2.default,
	    { color: shownColors[0].color },
	...
	Title.propTypes = {
	  shownColors: _react.PropTypes.array.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InterfaceTheme = function InterfaceTheme(_ref) {
	...
	exports.default = InterfaceTheme;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var conversions = __webpack_require__(224);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* MIT license */
	var colorNames = __webpack_require__(226);
	...
	var Tweet = function (_Component) {
	  ...
	  _createClass(Tweet, [{
	    ...
	    value: function handleClick() {
	      ...
	      var url = 'http://palettable.alecortega.com';

	      open('http://twitter.com/intent/tweet?text=' + text + '&url=' + url, 'tshare', 'height=400,width=550,resizable=1, toolbar=0,menubar=0,status=0, location=0');
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        _InterfaceTheme2.default,
	        { color: this.props.shownColors[0].color },
	        _react2.default.createElement(
	          'a',
	          { className: 'tweet', onClick: this.handleClick.bind(this) },
	          'TWEET'
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorList = function (_React$Component) {
	  _inherits(ColorList, _React$Component);

	  function ColorList() {
	    _classCallCheck(this, ColorList);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ColorList).apply(this, arguments));
	  }
	  ...
	  _createClass(ColorList, [{
	    ...
	    value: function render() {
	      ...
	      var colorItems = shownColors.map(function (color) {
	        return _react2.default.createElement(_ColorItem2.default, { key: color.id, color: color });
	      });

	      // FIXME: EWww refactor
	      var statusText = shownColors[shownColors.length - 1].statusText;
	      var containerClassName = isFetching ? 'searching ' + statusText : statusText;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ColorName = __webpack_require__(251);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Motion = __webpack_require__(238);

	exports.Motion = _interopRequire(_Motion);

	var _StaggeredMotion = __webpack_require__(245);

	exports.StaggeredMotion = _interopRequire(_StaggeredMotion);

	var _TransitionMotion = __webpack_require__(246);

	exports.TransitionMotion = _interopRequire(_TransitionMotion);

	var _spring = __webpack_require__(248);

	exports.spring = _interopRequire(_spring);

	var _presets = __webpack_require__(249);

	exports.presets = _interopRequire(_presets);

	// deprecated, dummy warning function

	var _reorderKeys = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapToZero = __webpack_require__(239);

	var _mapToZero2 = _interopRequireDefault(_mapToZero);

	var _stripStyle = __webpack_require__(240);

	var _stripStyle2 = _interopRequireDefault(_stripStyle);

	var _stepper3 = __webpack_require__(241);

	var _stepper4 = _interopRequireDefault(_stepper3);

	var _performanceNow = __webpack_require__(242);
	...
	var _shouldStopAnimation = __webpack_require__(244);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mergeDiff = __webpack_require__(247);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StepOne = __webpack_require__(253);

	var _StepOne2 = _interopRequireDefault(_StepOne);

	var _StepTwo = __webpack_require__(254);

	var _StepTwo2 = _interopRequireDefault(_StepTwo);

	var _StepThree = __webpack_require__(255);
	...
	var Onboarding = function Onboarding(_ref) {
	  ...
	  var steps = [_react2.default.createElement(_StepOne2.default, null), _react2.default.createElement(_StepTwo2.default, null), _react2.default.createElement(_StepThree2.default, null)];
	  var step = steps[onboardingStep] || false;
	  var color = shownColors[shownColors.length - 1].color;
